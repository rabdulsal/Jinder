...
class Swipe extends Component {
  ...
  renderCards() {
    if (this.props.data == null /* TODO: Placeholder for null case. Update on your own */ ||
    ...
    }); // Ensures cards ordered chronologically

    return Platform.OS === 'android' ? deck : deck.reverse(); // Workaround for Android ordering bug
  }
